...
export default function SignIn() {
  ...
  return (
    <section>
      <h1 className="text-3xl text-center mt-5 font-bold">Sign In
      </h1>
      <div className="flex
      justify-center
      flex-wrap
      ...
      px-6 py-12 max-w-6lx mx-auto" >
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form>
            ...
            rounded transition-ease-out mb-6" type={"email"} id="email" value={email} onChange={onChange} placeholder="Email Address"/>
          <div className="relative mb-6">
          <input className="w-full
          px-4 py-2 text-xl text-gray-700 bg-white border-gray-300
          rounded transition-ease-out" type={showPassword ? "text" : "password"} id="password" value={password} onChange={onChange} placeholder="Password"/>
          {showPassword ? (
